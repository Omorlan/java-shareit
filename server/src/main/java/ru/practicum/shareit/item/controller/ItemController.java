...
public class ItemController {
    ...
    @GetMapping
    public List<ItemCommentNextLastDto> getItemsByUser(@RequestHeader(Headers.USER_HEADER) Long userId) {
        return itemService.getItemsByUser(userId);
    }

    @GetMapping("/{itemId}")
    public ItemCommentNextLastDto getItemDto(@RequestHeader(Headers.USER_HEADER) Long userId,
    ...
    public CommentResponseDto addCommentToItem(@RequestHeader(Headers.USER_HEADER) Long userId,
                                               @PathVariable Long itemId,
