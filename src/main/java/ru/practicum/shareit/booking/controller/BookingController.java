...
public class BookingController {
    ...
    public BookingResponseDto approveBooking(@RequestHeader(USER_HEADER) Long userId,
    ...
    @GetMapping
    public List<BookingShortResponseDto> getBookings(@RequestHeader(USER_HEADER) Long userId,
                                                     @RequestParam(required = false, defaultValue = DEFAULT_STATE)
                                                     String state) {
        return bookingService.getBookings(userId, state);
    }

    @GetMapping("/owner")
    public List<BookingShortResponseDto> getBookingsOwner(@RequestHeader(USER_HEADER) Long userId,
                                                          @RequestParam(required = false, defaultValue = DEFAULT_STATE)
                                                          String state) {
